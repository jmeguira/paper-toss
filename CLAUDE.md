...
- Weave explanations into the code in small digestible chunks — show a few lines of code, explain them, then show the next few lines. Don't dump all explanation first and then all code, or vice versa.
...
4. Include doc updates in the PR alongside code changes
