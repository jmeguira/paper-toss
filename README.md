...
Mobile-first projectile throwing game. Swipe to throw at a distant target, with wind and spin affecting flight. Built with Phaser 3 + TypeScript + Vite.

## Setup

```sh
npm install
sh setup.sh   # installs git hooks (pre-commit type check)
```
